...
(custom-set-variables
 ...
 '(package-selected-packages
   '(ace-jump-mode beacon corfu counsel electric-pair-mode envrc
		   exec-path-from-shell flymake-ruff
		   highlight-indentation ivy-rich logview lsp-mode
		   lsp-treemacs lsp-ui markdown-mode orderless
		   org-download org-roam orgit projectile
		   rainbow-delimiters treemacs-icons-dired yaml-pro
		   yasnippet-snippets)))
(custom-set-faces
